...
\begin{longtable}{@{} P{0.21\linewidth} P{0.75\linewidth} @{}}
	...
	\item The produced quantity is below the remaining scanned quantity.
	\end{itemize} \\
	\midrule
	...
	\item The user enters a positive integer not exceeding the remaining scanned quantity.
...
operation is finished, cancelled, or interrupted, the live-data stream

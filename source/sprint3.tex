...
\begin{figure}[H]
  ...
  \caption{UML Use Case Diagram --- Sprint 3 (Part 1)}
...
\begin{figure}[H]
  ...
  \caption{UML Use Case Diagram --- Sprint 3 (Part 2)}
...
\uilabel{Finish Production Order} or \uilabel{Cancel Production Order} action depending on whether the progress has reached 100\%;

...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-3-Repport/MES_Sprint-3-Repport/diagrams/sequence/fetch-BOM.png}
  \caption{SD-21: Required components list.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-3-Repport/MES_Sprint-3-Repport/diagrams/sequence/fetch-production-cycle.png}
  \caption{SD-22: Declaration history.}

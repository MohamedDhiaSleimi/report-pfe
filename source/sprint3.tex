...
Figure~\ref{fig:s3-seq-finish_cancel-operation} covers the finish and cancel
...
\begin{figure}[H]
    ...
    \colorbox{black}{%
        \includegraphics[height=\imgheight,keepaspectratio]{./media/MES_Sprint-3-Repport/UI/desktop-opDetail-running.png}%
        \hspace{\fboxsep}%
        \includegraphics[height=\imgheight,keepaspectratio]{./media/MES_Sprint-3-Repport/UI/mobile-opDetail-running.png}%
    }
...
\begin{figure}[H]
	...
	\setlength{\fboxsep}{5pt}
	\colorbox{black}{%
		\includegraphics[height=\imgheight,keepaspectratio]{./media/MES_Sprint-3-Repport/UI/desktop-opDetail-finished.png}%
		\hspace{\fboxsep}%
		\includegraphics[height=\imgheight,keepaspectratio]{./media/MES_Sprint-3-Repport/UI/mobile-opDetail-finished.png}%
	}
...
\begin{figure}[H]
	...
	\setlength{\fboxsep}{5pt}
	\colorbox{black}{%
		\includegraphics[height=\imgheight,keepaspectratio]{./media/MES_Sprint-3-Repport/UI/desktop-opDetail-paused.png}%
		\hspace{\fboxsep}%
		\includegraphics[height=\imgheight,keepaspectratio]{./media/MES_Sprint-3-Repport/UI/mobile-opDetail-paused.png}%
	}
...
\begin{figure}[H]
	...
	\setlength{\fboxsep}{5pt}
	\colorbox{black}{%
		\includegraphics[height=\imgheight,keepaspectratio]{./media/MES_Sprint-3-Repport/UI/desktop-opDetail-cancelled.png}%
		\hspace{\fboxsep}%
		\includegraphics[height=\imgheight,keepaspectratio]{./media/MES_Sprint-3-Repport/UI/mobile-opDetail-cancelled.png}%
	}

...
\begin{longtable}{@{} P{0.10\linewidth} P{0.30\linewidth} P{0.55\linewidth} @{}}
	...
	Natural-language chat assistant, Node.js reverse proxy middleware,
	Python AI agent with intent classification, multi-provider LLM support,
	fuzzy machine resolution, composite fan-out queries, data enrichment,
	and contextual redirect actions. \\
	\bottomrule
\end{longtable}
...
The physical architecture of the MES system rests on three main nodes:
	...
	\begin{itemize}
	      ...
	      \item \textbf{Node.js Middleware}: a reverse-proxy layer running between the Flutter
	            ...
	            exposes a REST API consumed by Flutter, and routes AI chat requests to the Python
	            AI agent.

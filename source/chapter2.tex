...
\begin{longtable}{@{}P{0.21\linewidth}P{0.75\linewidth}@{}}
	...
	passwords and account statuses. They have access to all
...
\begin{longtable}{p{1.5cm} p{5cm} p{6.5cm} p{2cm}}
	...
	& \begin{itemize}[nosep, leftmargin=*]
	\item The user list displays each account's full information.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,keepaspectratio]{./media/MES_chapter-2-repport/global-useCase.png}

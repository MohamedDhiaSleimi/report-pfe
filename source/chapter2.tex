...
\begin{longtable}{@{} P{0.10\linewidth} P{0.30\linewidth} P{0.55\linewidth} @{}}
	...
	Monitoring dashboard and Administrator activity log, barcode view and printing, multi-language support (EN/FR/AR) and RTL layout, in-app onboarding tutorials. \\ \midrule

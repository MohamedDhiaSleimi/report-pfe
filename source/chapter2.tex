...
\begin{longtable}{@{}P{0.21\linewidth}P{0.75\linewidth}@{}}
	...
	orders. Mark operation as finished or cancel/interupt uneeded operations. \\[6pt]
	...
	\item \textbf{Production Operation Management}: This feature is the core of the
	      ...
	      \begin{itemize}
		 	...
		 	\item Declare produced quantities (validation: quantity $> 0$, no excess of the ordered quantity).
	      	\item View progress in real time (produced quantity, completion percentage, operation status).
			\item View the Bill of Materials for the current operation with component

...
\section*{Domain 1: Authentication \& User Management}
\label{domain1}
...
\section*{Domain 2: Machine Monitoring}
\label{domain2}
...
\section*{Domain 3: Production Execution \& Traceability}
\label{domain3}
...
\section*{Domain 4: Administration \& Monitoring}
\label{domain4}
...
\texttt{[DEVELOPMENT\_ENVIRONMENT: description of the workstations used (OS, RAM, CPU),
		tool versions (Flutter SDK, Dart SDK, BC version, VS Code AL Language and Flutter
		extensions), and any specific configuration required (docker, BC on-prem instance,

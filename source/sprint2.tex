...
\begin{longtable}{@{} P{0.21\linewidth} P{0.75\linewidth} @{}}
  ...
  \item The previous operation in the same production order (if any) is marked as \domainterm{Completed} or produced enough for the send ahead quantity.
  \end{itemize} \\
  \midrule
...
\modulename{MES Operation Status}) and dedicated codeunits

...
\begin{figure}[H]
  \centering
  \includegraphics[width=6in]{./media/MES_Sprint-2-Repport/diagrams/useCase/Screenshot_2026-03-16_124631.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-2-Repport/diagrams/sequence/fetch-machines.png}
  \caption{Fetch Machines --- Sequence Diagram.}
  \label{fig:s2-seq-fetch-machines}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-2-Repport/diagrams/sequence/waiting-orders.png}
  \caption{Get Machine Orders --- Sequence Diagram.}
...
\begin{figure}[H]
  ...
  \caption{Start Operation --- Sequence Diagram.}
  \label{fig:s2-seq-start-operation}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-2-Repport/placeholder-image.png}

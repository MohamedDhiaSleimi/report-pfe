...
\\ & &
	...
	\begin{itemize}[noitemsep, topsep=0pt, partopsep=0pt, leftmargin=*]
		...
		\item Implement PDF export with landscape/portrait toggle in \techname{UserBadgeDialog.\_exportPdf()}.
...
\\ & &
	...
	& \noindent\textit{Flutter}
	\begin{itemize}[noitemsep, topsep=0pt, partopsep=0pt, leftmargin=*]
		\item [need to fill the tasks here]
	\end{itemize}\\
...
\begin{longtable}{@{} P{0.22\linewidth} P{0.78\linewidth} @{}}
	...
	\item The system verifies the badge secret and generates a secure session token.
...
\modulename{MesSettingsProvider}, which manages the global settings fetch, dirty-state
detection, and save operations. Each provider wraps
...
% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=\linewidth,keepaspectratio]{./media/MES_Sprint-1-Repport/UI/pairingPage/wide.png}
% 	\caption{\uilabel{Paring Page}.}
% 	\label{fig:s1-ui-paring}
% \end{figure}

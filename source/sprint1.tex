...
use cases available exclusively to the \userrole{Administrator}, as well as the
\uilabel{Badge QR Scan} two-factor verification step and the
\uilabel{Paring / Host Configuration} first-launch flow.

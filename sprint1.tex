...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/UseCase_Diag.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-1-Repport/seqdiags/Login/Design-Diag.png}%
	\caption{Login --- Sequence Diagram.}%
	\label{fig:s1-seq-hl-login}%
\end{figure}%

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-1-Repport/seqdiags/Logout/Design-Diag.png}%
	\caption{Logout --- Sequence Diagram.}%
	\label{fig:s1-seq-hl-logout}%
\end{figure}%

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-1-Repport/seqdiags/ChangePw/Design-Diag.png}%
	\caption{Change Password --- Sequence Diagram.}%
	\label{fig:s1-seq-hl-ChangePw}%
\end{figure}%

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-1-Repport/seqdiags/AdminCreateUser/Design-Diag.png}%
	\caption{Admin --- Create User --- Sequence Diagram.}%
	\label{fig:s1-seq-hl-AdminCreateUser}%
\end{figure}%

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-1-Repport/seqdiags/AdminSetPw/Design-Diag.png}%
	\caption{Admin --- Set Password --- Sequence Diagram.}%
	\label{fig:s1-seq-hl-AdminSetPw}%
\end{figure}%

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-1-Repport/placeholder-image.png}%
	\caption{Admin --- Change Role / Work Centre --- Sequence Diagram.}%
	\label{fig:s1-seq-hl-AdminChangeRole}%
\end{figure}%

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{./media/MES_Sprint-1-Repport/placeholder-image.png}%
	\caption{Admin --- Toggle Account Active Status --- Sequence Diagram.}%
	\label{fig:s1-seq-hl-AdminToggleActive}%
\end{figure}%
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/image2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/image3.png}
...
as illustrated in Figure~\ref{fig:s1-flutter-architecture}.

\begin{figure}[H]
	\centering
	\includegraphics[width=2.71913in]{./media/MES_Sprint-1-Repport/image13.png}
	\caption{\techname{Flutter} layered architecture.}
	\label{fig:s1-flutter-architecture}
\end{figure}
...
The \uilabel{login} method sends user credentials and device ID to the
\apiendpoint{/login} endpoint and parses the returned session token, role, and
\domainterm{needChangePassword} flag. The \uilabel{logout} method sends the active
session token to the \apiendpoint{/logout} endpoint to trigger server-side token
revocation. The \uilabel{change password} method submits the current password,
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/image23.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/image24.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/image25.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/image26.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/image27.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/image28.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{./media/MES_Sprint-1-Repport/placeholder-image.png}

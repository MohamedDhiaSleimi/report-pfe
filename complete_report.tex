...
\noindent\textbf{Français :} [Résumé en français, 100–150 mots.] \\[4pt]
\noindent\textbf{Mots-clés :} MES, Flutter, Microsoft Dynamics 365 Business Central, AL, production, traçabilité \\[12pt]
\noindent\textbf{English :} [Abstract in English, 100–150 words.] \\[4pt]
\noindent\textbf{Keywords:} MES, Flutter, Microsoft Dynamics 365 Business Central, AL, production, traceability \\[12pt]
\begin{Arabic}
  \begin{RTL}
    \noindent\textbf{العربية:} ملخص باللغة العربية، \LR{100--150} كلمة . \\[4pt]
    \noindent\textbf{الكلمات المفتاحية:} نظام تنفيذ التصنيع، فلاتر، مايكروسوفت داينامكس \LR{365}
  \end{RTL}
\end{Arabic}
\newpage

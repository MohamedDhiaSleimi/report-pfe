...
\textbf{Mots-clés :} MES, Système d'Exécution de la Production, Business Central, Flutter, OData V4, Intégration ERP, Industrie 4.0, Suivi de Production, Scrum \\[12pt]
...
records.\\[4pt]
\textbf{Keywords:} MES, Manufacturing Execution System, Business Central,
Flutter, OData V4, ERP Integration, Industry 4.0, Production Tracking,
Scrum. \\[12pt]
\begin{Arabic}
  \begin{RTL}
    \textbf{العربية:} يقدّم هذا المشروع نظام تنفيذ التصنيع (MES) المدمج أصلاً مع Microsoft Dynamics 365 Business Central، والذي طُوِّر خلال تدريب مدته أربعة أشهر في شركة Mavision للاستشارات. يعالج النظام غياب الرؤية الفورية لأرضية الإنتاج في المؤسسات الصناعية التي تعتمد على التتبع الورقي. تتألف البنية من أربعة مكوّنات: امتداد AL يكشف نقاط نهاية OData V4 مع مصادقة قائمة على الرمز المميز؛ وخادم وسيط Node.js؛ وتطبيق Flutter متعدد المنصات يستهدف Android وiOS والويب وسطح المكتب؛ ووكيل ذكاء اصطناعي Python FastAPI يتيح الاستعلام بالغة الطبيعية عن حالات الآلات وأوامر الإنتاج. يحصل المشغّلون والمشرفون على مراقبة الآلات وإدارة دورة حياة العمليات وتتبع قوائم المواد ومسح الباركود والإبلاغ عن الخردة وطباعة الملصقات. تدعم الواجهة العربية والفرنسية والإنجليزية مع تخطيط RTL تلقائي. اتّبع التطوير منهجية Scrum عبر أربعة سبرينتات. \\[4pt]
    \textbf{الكلمات المفتاحية:} نظام تنفيذ التصنيع، Business Central، Flutter، \LR{OData V4}، تكامل نظام تخطيط الموارد، الصناعة \LR{4.0}، تتبع الإنتاج، \LR{Scrum}
  \end{RTL}
\end{Arabic}
\newpage
